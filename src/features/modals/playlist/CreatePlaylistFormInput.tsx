...
export default function CreatePlaylistFormInput({
  ...
  return (
    <>
      {/* 제목 입력 */}
      <div>
        <label className="mb-2 block text-sm font-medium text-gray-700">타이틀</label>
        <input
          type="text"
          name="title"
          value={playlistTitle}
      ...
      <div>
        ...
        <textarea
          ...
          name="description"
          rows={4}
          className="w-full resize-none rounded-lg border border-gray-300 px-4 py-3 text-sm transition-all focus:ring-2 focus:ring-black focus:outline-none"
        />
      </div>
