        ...
        <div className="space-y-4">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-4">
              <label className="shrink-0 text-sm text-gray-600 md:w-32">현재 비밀번호</label>
              <input
                ...
                className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm transition-all focus:ring-2 focus:ring-black focus:outline-none"
              />
            </div>
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-4">
              <label className="shrink-0 text-sm text-gray-600 md:w-32">새 비밀번호</label>
              <input
                name="newPassword"
            ...
            <div className="flex flex-col gap-2 md:flex-row md:items-start md:gap-4">
              <label className="shrink-0 text-sm text-gray-600 md:w-32 md:pt-3">
                새 비밀번호 확인
              </label>
          ...
          <div className="flex gap-3 pt-4">
            ...
            {isLoading ? (
              <button
                disabled
                className="rounded-lg bg-gray-200 px-6 py-2 text-sm font-medium text-gray-700"
              >
                저장 중
              </button>
            ) : (
              <button
                ...
                className="rounded-lg bg-black px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-700"
              >
                저장
              </button>
            )}
